...
const TRANSLATIONS = {
  ...
  zh: {
    ...
    labelNotes:      '备注（可选）',
    notesPh:         '例：周五晚 第3局',
    labelScoreMultiplier: '积分倍数',
    scoreMultiplierDesc:  '为本局所有积分设置倍数',
    mult1x:  '×1  标准',
    mult2x:  '×2  双倍',
    mult3x:  '×3  三倍',
    mult10x: '×10 十倍',
  ...
  en: {
    ...
    labelScoreMultiplier: 'Score Multiplier',
    scoreMultiplierDesc:  'Multiply all points for this game',
    mult1x:  '×1  Standard',
    mult2x:  '×2  Double',
    mult3x:  '×3  Triple',
    mult10x: '×10 Ten times',
    badgeDouble:       '×',
